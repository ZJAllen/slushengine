...
class sBoard:
  ...
  def initGPIOState(self):
    ...
    gpio.setup(SLZ.MTR0_ChipSelect, gpio.OUT)
    gpio.setup(SLZ.MTR1_ChipSelect, gpio.OUT)
    gpio.setup(SLZ.MTR2_ChipSelect, gpio.OUT)
    gpio.setup(SLZ.MTR3_ChipSelect, gpio.OUT)
    gpio.setup(SLZ.MTR4_ChipSelect, gpio.OUT)
    gpio.setup(SLZ.MTR5_ChipSelect, gpio.OUT)
    gpio.setup(SLZ.MTR6_ChipSelect, gpio.OUT)
    gpio.output(SLZ.MTR0_ChipSelect, gpio.HIGH)
    gpio.output(SLZ.MTR1_ChipSelect, gpio.HIGH)
    gpio.output(SLZ.MTR2_ChipSelect, gpio.HIGH)
    gpio.output(SLZ.MTR3_ChipSelect, gpio.HIGH)
    gpio.output(SLZ.MTR4_ChipSelect, gpio.HIGH)
    gpio.output(SLZ.MTR5_ChipSelect, gpio.HIGH)
    gpio.output(SLZ.MTR6_ChipSelect, gpio.HIGH)
